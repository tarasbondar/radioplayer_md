        ...
        <section class="login">
            <div class="container">
                ...
                <div class="login__wrapper">
                    <form action="{{ route('register') }}" method='POST' id="register-form" data-validate>

                        @csrf

                        <div class="input form-floating _icon">
                            <input type="text" class="form-control" placeholder="{{ __('auth.name') }}" name="name" id="name" >
                        ...
                        <div class="input form-floating _icon">
                            <input type="password" class="form-control" placeholder="{{ __('auth.password') }}" name="password" id="password" >
                        ...
                        <div class="input form-floating _icon">
                            <input type="password" class="form-control" placeholder="{{ __('auth.repeatPassword') }}" name="password_confirmation" id="password-confirm" >
                        ...
                        <div class="input input__inner">
                            <input class="input__checkbox" type="checkbox" id="agree" name="agree" >
                ...
                <div class="login__wrapper-action">
                    ...
                    <a href="{{route('login.google')}}" data-ignore class="btn btn_google-sign-in">
