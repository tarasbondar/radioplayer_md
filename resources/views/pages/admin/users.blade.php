    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 text-right mt-3 mb-3">
                <a href="/admin/users/add" class="btn btn-primary" type="button">Add</a>
            </div>
        </div>
        ...
        <div class="row mb-3">
                ...
                <div class="col-md-9 row">
                    ...
                    <div class="col-md-5"> <input id="username" type="text" class="form-control" name="username" value="{{ app('request')->input('username') }}" placeholder="Name"> </div>
                ...
                @foreach ($users as $u)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="view-user view-{{ $u['id'] }}">View</a>
