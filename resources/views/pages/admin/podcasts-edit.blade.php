            ...
            <div class="col-md-12">
                ...
                <form method="POST" action="/admin/podcasts/save" enctype = 'multipart/form-data'>
                    ...
                    <div class="mb-3 form-group row"> {{-- Text editor here --}}
                        ...
                        <div class="col-md-6"> <textarea id="description" type="text" class="form-control {{--ckeditor-custom--}}" name="description" rows="6" required> {{ @$podcast['description'] }} </textarea> </div>
                    </div>
                    <div class="mb-3 form-group row">
