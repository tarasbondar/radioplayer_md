        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <form method="POST" action="/admin/stations/save" enctype='multipart/form-data'>
                    ...
                    <div class="mb-3 form-group row">
                        <label for="group-id" class="col-md-4 col-form-label text-md-right">Группа</label>
                        <div class="col-md-6">
                    ...
                    <div class="mb-3 form-group row">
                        <label for="source" class="col-md-4 col-form-label text-md-right">Источник</label>
                        <div class="col-md-6"> <input id="source" type="text" class="form-control" name="source" value="{{ @$station['source'] }}" required> </div>
                    </div>
                    <div class="mb-3 form-group row">
                        <label for="source-hd" class="col-md-4 col-form-label text-md-right">HD Источник</label>
                    ...
                    <div class="mb-3 form-group">
                        <label for="categories-checkbox" class="col-md-4 col-form-label text-md-right">Категории</label>
                    ...
                    <div class="mb-3 form-group">
                        <label for="tags-checkbox" class="col-md-4 col-form-label text-md-right">Тэги</label>
                        @foreach($tags as $t)
                    ...
                    <div class="mb-3 form-group row">
                        <label for="order" class="col-md-4 col-form-label text-md-right">Порядок</label>
