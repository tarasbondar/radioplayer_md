...
@endphp
<aside class="player player_animated" id="player-podcasts" data-player="podcast">
...
<!--    </div>-->
    ...
    <div class="np-modal scrollbar player-animated" data-np-modal>
	    <div class="np-modal__playing" data-np-modal-player>
		    <div id="playerDragHandler">
                <div class="now-playing" data-now-playing>
                    <input id="audio-source" type="text" value="{{ @$current['source_url']  }}" readonly hidden>
                    <input id="start-time" type="text" value="{{ @$current['start_time']  }}" readonly hidden>
